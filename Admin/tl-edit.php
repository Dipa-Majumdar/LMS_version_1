            ...
            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 p0 admin-sidebar">
                <div class="admin-list">
                    <ul class="list-group">
						...
						<li class="list-group-item"><a class="active"><i class="fa fa-users"></i><span >Team Leaders</span></a></li>
...
<div class="admin-area" id="area">
    ...
    <form name="myForm">
     ...
     <input disabled type="text" class="form-control name="eid">
     ...
     <input type="text" class="form-control name="name">
      ...
      <input type="date" class="form-control" name="date">
	   <div class="errors-container">
                    ...
                    <div class="mt20">
                        <button class="btn btn-primary" type="button" id="Button" onclick="clickmethod()"> Update</button>
