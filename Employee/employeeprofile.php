...
<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
  ...
  <div class="row2">
  <h3 class="mb15"> Leaves Alloted </h3>
  <p>  7 </p>
  </div>  <!-- row2 -->
   <div class="row">
  <div class="col1">
  <label>Leaves Taken</label>
  <input type="text" class="form-control" id="leavestaken" placeholder="" name="leavestaken">
  </div>  <!-- col1 -->
  <div class="col2">
  <label>Leaves Available</label>
  <input type="text" class="form-control" id="leavesavailable" placeholder="" name="leavesavailable">
  </div>  <!-- col2 -->
  </div>
</div>   <!-- containerbox -->
<div class="apply_button">
<button aria-haspopup="true"  class="btn btn-primary" type="submit">
		Apply
		</button>
</div> <!-- apply_button -->
</div>  	  <!-- col --> 
